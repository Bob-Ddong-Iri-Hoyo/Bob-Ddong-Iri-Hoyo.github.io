---
title: 安装 Bob-Ddong-Iri-Hoyo 启动器
...
<div class="video-container">
  <iframe
    src="https://www.youtube-nocookie.com/embed/P9qkAZYyzeg?cc_load_policy=1&cc_lang_pref=zh&hl=zh-CN"
...
<Aside type="note" title="字幕提示">
  本视频包含字幕。如果字幕没有自动显示，或显示为其他语言，请在 YouTube
  播放器中点击字幕按钮，并选择对应语言观看。
</Aside>
