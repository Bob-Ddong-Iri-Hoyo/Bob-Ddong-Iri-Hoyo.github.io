...
<CardGrid>
  <LinkCard
    title="🟢 Stable"
    description="The default channel for official and beta releases. Recommended for most users."
    href="https://github.com/Bob-Ddong-Iri-Hoyo/BDIH-Launcher/releases"
  />

  <LinkCard
    title="🟡 Staging"
    description="The final verification channel before Stable Beta and official Stable releases."
    href="https://github.com/Bob-Ddong-Iri-Hoyo/BDIH-Launcher-TestProduction/releases"
  />

  <LinkCard
    title="🔴 Nightly"
    description="An experimental channel where the latest development changes are built automatically."
    href="https://github.com/Bob-Ddong-Iri-Hoyo/BDIH-Launcher-nightly/releases"
  />
</CardGrid>
<Aside type="tip" title="Which version should I install?">
  Unless you have a specific reason, install the **Stable version**.  
  Staging and Nightly are intended for testing.
</Aside>
...
<div class="video-container">
  <iframe
    src="https://www.youtube-nocookie.com/embed/P9qkAZYyzeg?cc_load_policy=1&cc_lang_pref=en&hl=en"
...
<Aside type="note" title="Caption notice">
  This video includes captions. If captions do not appear automatically or appear
  in another language, click the captions button in the YouTube player and
...
Open Terminal and run the command. macOS will install Rosetta 2.
